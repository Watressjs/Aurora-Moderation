...
module.exports = {
    ...
    run: async(client, message, args) => {
        ...
        message.channel.send(embed2.setDescription(`${member} adlı kullanıcı \`${name} | ${age}\` isminde, (<@&880923348815732810>,<@&880923348815732809>) olarak kayıt edildi! `)
